...
package com.android.launcher3.descendant.icon;
...
public class DescendantIconFactory extends BaseIconFactory {

    private final IconPackStore mIconPackStore;

    public DescendantIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
